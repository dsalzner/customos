...
Void_t* public_mALLOc(size_t bytes) {
  COS_TINYCC_DEBUG("malloc.c::public_mALLOc\n");
...
#endif
{
  COS_TINYCC_DEBUG("malloc.c::sYSMALLOc\n");
  ...
  */
  ...
  if (have_fastchunks(av)) {
    ...
    return cos_malloc(nb - MALLOC_ALIGN_MASK);
  }


#if HAVE_MMAP
  COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - in have_mmap\n");
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - cont'd\n");
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - contiguous\n");
  ...
  */
  ...
  if (brk != (char*)(MORECORE_FAILURE)) {
    COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - MORECORE_FAILURE\n");
    ...
    */
    ...
    COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - update statistics\n");
    ...
    COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - allocate\n");
    ...
    if ((CHUNK_SIZE_T)(size) >= (CHUNK_SIZE_T)(nb + MINSIZE)) {
      ...
      COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - return chunk\n");
      return chunk2mem(p);
    }
  ...
  COS_TINYCC_DEBUG("malloc.c::sYSMALLOc - fail path\n");
...
void * cos_malloc(size_t bytes)
{
  COS_TINYCC_DEBUG("malloc.c::cos_malloc\n"); 
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - checked_request2size\n"); 
  checked_request2size(bytes, nb);

  /*
    Bypass search if no frees yet
   */
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - malloc_consolidate\n"); 
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - check_remalloced_chunk\n"); 
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - in_smallbin_range\n"); 
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - freed or remain\n"); 
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - search chunk\n"); 
  ...
  */
  ...
  COS_TINYCC_DEBUG("malloc.c::cos_malloc - cont sYSMALLOc\n"); 
...
#endif
{
  ...
  COS_TINYCC_DEBUG("mallo.c::malloc_consolidate\n"); 
  ...
  */
  ...
  if (av->max_fast != 0) {
    ...
    COS_TINYCC_DEBUG("mallo.c::malloc_consolidate - call unsorted_chunks\n"); 
  ...
  COS_TINYCC_DEBUG("mallo.c::malloc_consolidate - done\n"); 
}
...
#endif
{
  ...
  if (oldmem == 0) return cos_malloc(bytes);
  ...
  if (!chunk_is_mmapped(oldp)) {
    ...
    if ((CHUNK_SIZE_T)(oldsize) >= (CHUNK_SIZE_T)(nb)) {
      ...
      /* allocate, copy, free */
        ...
        newmem = cos_malloc(nb - MALLOC_ALIGN_MASK);
        if (newmem == 0)
...
#endif
{
  ...
  if (alignment <= MALLOC_ALIGNMENT) return cos_malloc(bytes);
  ...
  */
  ...
  m  = (char*)(cos_malloc(nb + alignment + MINSIZE));
...
#endif
{
  ...
  Void_t* mem = cos_malloc(n_elements * elem_size);
...
/* sbrk for windows */
static void *sbrk (long size) {
    COS_TINYCC_DEBUG("malloc.c::sbrk - for windows\n");
